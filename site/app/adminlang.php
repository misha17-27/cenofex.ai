...
function admin_phrases(): array
{
    return [
        ...
        'Закрывайте только на время работ — закрытый сайт выпадает из выдачи.' => ['Close it only during maintenance — a closed site drops out of search results.', 'Yalnız işlər zamanı bağlayın — bağlı sayt axtarış nəticələrindən çıxır.'],
