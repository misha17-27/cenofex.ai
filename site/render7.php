<?php
/**
 * ВАРИАНТ 7 — то же, что вариант 6, но шапка тёмная, как футер:
 * фирменный паттерн pattern-dark, светлый логотип и белая навигация.
 * Данные — из БД.
